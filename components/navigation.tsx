    ...
    <div className="w-full flex justify-center pt-4 fixed top-0 left-0 z-50">
      <nav className="w-[85%] py-3 px-5 flex items-center justify-between bg-white rounded-full border border-gray-300">
        ...
        <div className="hidden md:flex items-center space-x-10">
          <Link href="#kalkulacka" className="text-sm font-medium text-gray-700 hover:text-gray-900">
          Kolik ušetřím?
          </Link>
          <Link href="#jak-to-funguje" className="text-sm font-medium text-gray-700 hover:text-gray-900">
          Jak to funguje?
          </Link>
          <Link href="#proc-vybrat-scanpay" className="text-sm font-medium text-gray-700 hover:text-gray-900">
            Proč vybrat ScanPay?
          </Link>
          ...
          <Link href="#cenik" className="text-sm font-medium text-gray-700 hover:text-gray-900">
            Ceník
          </Link>
        </div>
        ...
        <div className={cn(
          ...
          <div className="flex flex-col p-4 space-y-4">
            <Link href="/how-it-works" className="text-sm text-gray-600 hover:text-gray-900 py-2">
              How it works
            </Link>
            <Link href="/writing-examples" className="text-sm text-gray-600 hover:text-gray-900 py-2">
              Writing Examples
            </Link>
            <Link href="/pricing" className="text-sm text-gray-600 hover:text-gray-900 py-2">
              Pricing
            </Link>
            <Link href="/blog" className="text-sm text-gray-600 hover:text-gray-900 py-2">
              Blog
            </Link>
          </div>
        </div>
